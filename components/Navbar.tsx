...
export function Navbar() {
  ...
  function getActiveLink(activeLink: string, activeClass = "bg-black") {
    return twMerge(
          ...
          <div className='flex flex-1 items-center justify-center lg:items-stretch lg:justify-start'>
            ...
            <div className='hidden lg:ml-6 lg:block'>
              <div className='flex space-x-2'>
                ...
                <Link href='/properties' className={getActiveLink("/properties")}>
                  Properties
                </Link>
                {isLoggedIn && (
                  <Link href='/properties/add' className={getActiveLink("/properties/add")}>
                    Add Property
                  </Link>
                )}
              </div>
